  ...
  try {
    ...
    const created = await prisma.services_sub_cat.create({
      data: {
        ...
        subheading: stripHtml(subheading),

        subspan1: stripHtml(subspan1),

        subspan2: stripHtml(subspan2),

        subtitle_para1: stripHtml(subtitle_para1),

        subtitle_para2: stripHtml(subtitle_para2),
  ...
  try {
    ...
    const data = {
      ...
      subheading: req.body.subheading
        ? stripHtml(req.body.subheading)
        : existing.subheading,

      subspan1: req.body.subspan1
        ? stripHtml(req.body.subspan1)
        : existing.subspan1,

      subspan2: req.body.subspan2
        ? stripHtml(req.body.subspan2)
        : existing.subspan2,

      subtitle_para1: req.body.subtitle_para1
        ? stripHtml(req.body.subtitle_para1)
        : existing.subtitle_para1,

      subtitle_para2: req.body.subtitle_para2
        ? stripHtml(req.body.subtitle_para2)
        : existing.subtitle_para2,
    };
