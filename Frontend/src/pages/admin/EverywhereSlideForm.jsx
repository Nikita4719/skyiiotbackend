...
import ClassicEditor from '@ckeditor/ckeditor5-build-classic';export default function EverywhereSlideForm() {
    ...
    <div className="mt-12 mb-8 px-6">
      <Card className="w-full p-10 shadow-xl rounded-2xl">
        ...
        <Typography variant="h4" className="mb-2">
          {id ? "Edit Everywhere Slide" : "Add Everywhere Slide"}
        </Typography>

        <Typography variant="small" color="gray" className="mb-8">
          Manage Everywhere Slide
        </Typography>
