...
import ClassicEditor from '@ckeditor/ckeditor5-build-classic';export default function ManagementSectionForm() {
    ...
    <div className="mt-12 mb-8 px-6">
      <Card className="w-full p-10 shadow-xl rounded-2xl">
        ...
        <Typography variant="h4" className="mb-2">
          {id ? "Edit Management Section" : "Add Management Section"}
        </Typography>

        <Typography variant="small" color="gray" className="mb-8">
          Manage Management Section
        </Typography>
