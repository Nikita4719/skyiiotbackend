...
exports.getOne = async (req, res) => {
  try {
    ...
    const data = await prisma.solution_card.findUnique({
      where: { id },
    });
...
exports.create = async (req, res) => {
  ...
  throw err;
    ...
    const created = await prisma.solution_card.create({
      data,
    });
...
exports.update = async (req, res) => {
  try {
    ...
    const existing = await prisma.solution_card.findUnique({
      where: { id },
    });
...
exports.remove = async (req, res) => {
  try {
    ...
    await prisma.solution_card.delete({
      where: { id },
    });
